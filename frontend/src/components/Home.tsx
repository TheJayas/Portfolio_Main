  ...
  return (
    <div className="pb-20 pt-28 h-lvh w-lvw relative">
      ...
      <div className='w-1/2 h-full flex flex-col justify-center pb-40'>
        <TextGenerateEffect
          words="Hi! I'm Shivam, a Full-stack Web and App Developer"
      ...
      <DockIcon onClick={() => {
        window.open('https://github.com/TheJayas','_blank');
      }}>
        <Icons.gitHub className="h-6 w-6" />
      </DockIcon>
      <DockIcon onClick={() => {
        window.open('https://gitlab.freedesktop.org/TheJayas','_blank');
      }
      }>
        <IconBrandGitlab className="h-6 w-6" />
      </DockIcon>
      <DockIcon onClick={() => {
        window.open('https://www.linkedin.com/in/shivam-jaiswal-54088a266/','_blank');
      }}>
        <Icons.linkedIn className="h-6 w-6" />
      </DockIcon>
      <DockIcon onClick={() => {
        window.open('mailto:shivamjais.iitm@gmail.com','_blank');
      }}>
        <Icons.gmail className="h-6 w-6" />
      </DockIcon>
      <DockIcon onClick={() => {
        window.open('https://t.me/TheJayas','_blank');
      }}>
